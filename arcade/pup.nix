...
let
  arcadeService = pkgs.writeShellScriptBin "run-arcade.sh" ''
    ...
    export PAYOUT_DOGE_ADDRESS="''${PAYOUT_DOGE_ADDRESS:-DTqAFgNNUgiPEfGmc4HZUkqJ4sz5vADd1n}"
    export PAYOUT_GAME_DOGE_INDY_500="''${PAYOUT_GAME_DOGE_INDY_500:-}"
    export PAYOUT_GAME_FEAR_THE_DOGE="''${PAYOUT_GAME_FEAR_THE_DOGE:-DTqAFgNNUgiPEfGmc4HZUkqJ4sz5vADd1n}"
